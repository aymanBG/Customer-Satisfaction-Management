...
<div class="col-lg-12">
	<div class="row">
		...
		<div class="col-md-8">
            ...
            <div id="fth">
                      ...
                      <label for="option_<?php echo $k ?>" class="radio-inline" id="jlo">
		                        <input type="radio"  id="option_<?php echo $k ?>" name="answer[<?php echo $row['id'] ?>]" value="<?php echo $k ?>" checked=""><?php echo "&".$v ?>
		                        </label>
		          </div>
								<?php endforeach; ?>
            </div>
  ...
  <div class="feedback">
    <div class="rating">
      <input type="radio" name="frm_op" id="rating-5" value = "1">
      <label for="rating-5"></label>
      <input type="radio" name="frm_op" id="rating-4" value = "2">
      <label for="rating-4"></label>
      <input type="radio" name="frm_op" id="rating-3" value = "3">
      <label for="rating-3"></label>
      <input type="radio" name="frm_op" id="rating-2" value = "4">
      <label for="rating-2"></label>
      <input type="radio" name="frm_op" id="rating-1" value = "5">
