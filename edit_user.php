...
<form method="POST" action="" enctype="multipart/form-data">
    ...
    <div class="form-group mb-3">
        ...
        <input type="text" class="form-control" name="contact"  id="validationCustom04" placeholder="Tele" required value="<?php echo isset($contact) ? $contact : '' ?>">
            <div class="invalid-feedback">
                champ requis
            </div>
    </div>
    <div class="form-group mb-3">
        ...
        <input type="text" class="form-control" name="address" id="validationCustom05" placeholder="Zip" value="<?php echo isset($address) ? $address : '' ?>" required>
        <div class="invalid-feedback">
            champ requis
        </div>
    </div>
	...
	<b class="text-muted"></b>
						<?php if($_SESSION['login_type'] == 1): ?>
						<div class="form-group mb-3">
							<label for="" class="control-label">Rôle</label>
	...
	<div class="form-group mb-3">
        <img src="google-logo.png" alt="HTML tutorial" style="width:10%;">
	...
	<div class="form-group mb-3">
        <img src="Facebook-Logo.png" alt="HTML tutorial" style="width:10%;;">
    	...
    	<div class="form-group mb-3">
        <img src="Tripadvisor-Logo.png" alt="HTML tutorial" style="width:10%;">
        <input type="text" class="form-control" name="tpv" id="validationCustom07" placeholder="Facebook Link" value="<?php echo isset($tpv) ? $tpv : '' ?>" required>
	...
	$('#manage_user').submit(function(e){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					alert_toast('client modifié',"success");
					setTimeout(function(){
