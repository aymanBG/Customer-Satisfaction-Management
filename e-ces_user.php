...
$rst1 = $conn->query("SELECT a.survey_id,a.question_id, q.frm_option, a.user_id,COUNT(a.answer) as t,a.answer from answers as a, questions as q where a.question_id = q.id and a.survey_id = 9 and a.date_created between '".$no."' AND '".$on."' and q.id = 101 and a.user_id = '" . $mais . "' GROUP by a.answer");
$ans1 = array();
$sp1 = 0;
$sr1 = 0;
$sd1 = 0;
...
$rst2 = $conn->query("SELECT a.survey_id,a.question_id, q.frm_option, a.user_id,COUNT(a.answer) as t,a.answer from answers as a, questions as q where a.question_id = q.id and a.survey_id = 9 and a.date_created between '".$no."' AND '".$on."' and q.id = 103 and a.user_id = '" . $mais . "' GROUP by a.answer");
$ans2 = array();
$sp2 = 0;
$sr2 = 0;
$sd2 = 0;
...
$rst3 = $conn->query("SELECT a.survey_id,a.question_id, q.frm_option, a.user_id,COUNT(a.answer) as t,a.answer from answers as a, questions as q where a.question_id = q.id and a.survey_id = 9 and a.date_created between '".$no."' AND '".$on."' and q.id = 105 and a.user_id = '" . $mais . "' GROUP by a.answer");
$ans3 = array();
$sp3 = 0;
$sr3 = 0;
$sd3 = 0;
...
//query to get data from the table
$tot = $conn->query("SELECT a.survey_id, q.frm_option, a.user_id, a.answer from answers as a, questions as q where a.question_id = q.id and a.survey_id = 9 and q.id = 101 and a.user_id = '" . $mais . "' and answer <> '' ORDER BY user_id desc")->num_rows;
$rsto = $conn->query("SELECT a.survey_id,a.question_id, q.frm_option, a.user_id,COUNT(a.answer) as t,a.answer , a.date_created from answers as a, questions as q where a.question_id = q.id and a.survey_id = 9 and q.id = 101  and a.user_id = '" . $mais . "' and a.answer != 'kyCzj' AND a.answer !='pYSMz' and a.answer !='AZlJj' and a.answer !='tsOFw' and a.answer !='woXvk' and a.answer !='dPQwE' and a.answer !='TuvNe' and a.answer !='GbckJ' and a.answer !='gItBq' GROUP by EXTRACT(YEAR_MONTH FROM a.date_created) order by a.date_created asc;");
...
//query to get data from the table
$tot = $conn->query("SELECT a.survey_id, q.frm_option, a.user_id, a.answer from answers as a, questions as q where a.question_id = q.id and a.survey_id = 9 and q.id = 101 and a.user_id = '" . $mais . "' and answer <> '' ORDER BY user_id desc")->num_rows;
$rs = $conn->query("SELECT a.survey_id,a.question_id, q.frm_option, a.user_id,COUNT(a.answer) as t,a.answer , a.date_created from answers as a, questions as q where a.question_id = q.id and a.survey_id = 9 and q.id = 101  and a.user_id = '" . $mais . "' and a.answer != 'fThXp' AND a.answer !='XJdKP' and a.answer !='Ymhvn' and a.answer !='UWiDF' and a.answer !='lqoLa' and a.answer !='hqsDn' GROUP by EXTRACT(YEAR_MONTH FROM a.date_created) order by a.date_created asc;");
...
//query to get data from the table
$tot = $conn->query("SELECT a.survey_id, q.frm_option, a.user_id, a.answer from answers as a, questions as q where a.question_id = q.id and a.survey_id = 9 and q.id = 105 and a.user_id = '" . $mais . "' and answer <> '' ORDER BY user_id desc")->num_rows;
$rstp = $conn->query("SELECT a.survey_id,a.question_id, q.frm_option, a.user_id,COUNT(a.answer) as t,a.answer , a.date_created from answers as a, questions as q where a.question_id = q.id and a.survey_id = 9 and q.id = 105 and a.user_id = '" . $mais . "' and a.answer != 'kyCzj' AND a.answer !='pYSMz' and a.answer !='AZlJj' and a.answer !='tsOFw' and a.answer !='woXvk' and a.answer !='dPQwE' and a.answer !='TuvNe' and a.answer !='GbckJ' and a.answer !='gItBq' GROUP by EXTRACT(YEAR_MONTH FROM a.date_created) order by a.date_created asc;");
...
//query to get data from the table
$tot = $conn->query("SELECT a.survey_id, q.frm_option, a.user_id, a.answer from answers as a, questions as q where a.question_id = q.id and a.survey_id = 9 and q.id = 105 and a.user_id = '" . $mais . "' and answer <> '' ORDER BY user_id desc")->num_rows;
$rsti = $conn->query("SELECT a.survey_id,a.question_id, q.frm_option, a.user_id,COUNT(a.answer) as t,a.answer , a.date_created from answers as a, questions as q where a.question_id = q.id and a.survey_id = 9 and q.id = 105 and a.user_id = '" . $mais . "' and a.answer != 'fThXp' AND a.answer !='XJdKP' and a.answer !='Ymhvn' and a.answer !='UWiDF' and a.answer !='lqoLa' and a.answer !='hqsDn' GROUP by EXTRACT(YEAR_MONTH FROM a.date_created) order by a.date_created asc;");
...
//query to get data from the table
$tot = $conn->query("SELECT a.survey_id, q.frm_option, a.user_id, a.answer from answers as a, questions as q where a.question_id = q.id and a.survey_id = 9 and q.id = 103 and a.user_id = '" . $mais . "' and answer <> '' ORDER BY user_id desc")->num_rows;
$rstk = $conn->query("SELECT a.survey_id,a.question_id, q.frm_option, a.user_id,COUNT(a.answer) as t,a.answer , a.date_created from answers as a, questions as q where a.question_id = q.id and a.survey_id = 9 and q.id = 103  and a.user_id = '" . $mais . "' and a.answer != 'kyCzj' AND a.answer !='pYSMz' and a.answer !='AZlJj' and a.answer !='tsOFw' and a.answer !='woXvk' and a.answer !='dPQwE' and a.answer !='TuvNe' and a.answer !='GbckJ' and a.answer !='gItBq' GROUP by EXTRACT(YEAR_MONTH FROM a.date_created) order by a.date_created asc;");
...
//query to get data from the table
$tot = $conn->query("SELECT a.survey_id, q.frm_option, a.user_id, a.answer from answers as a, questions as q where a.question_id = q.id and a.survey_id = 9 and q.id = 103 and a.user_id = '" . $mais . "' and answer <> '' ORDER BY user_id desc")->num_rows;
$rsty = $conn->query("SELECT a.survey_id,a.question_id, q.frm_option, a.user_id,COUNT(a.answer) as t,a.answer , a.date_created from answers as a, questions as q where a.question_id = q.id and a.survey_id = 9 and q.id = 103  and a.user_id = '" . $mais . "' and a.answer != 'fThXp' AND a.answer !='XJdKP' and a.answer !='Ymhvn' and a.answer !='UWiDF' and a.answer !='lqoLa' and a.answer !='hqsDn' GROUP by EXTRACT(YEAR_MONTH FROM a.date_created) order by a.date_created asc;");
